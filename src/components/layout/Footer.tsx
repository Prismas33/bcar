      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8">
        ...
        <div className="hidden md:grid md:grid-cols-4 gap-6">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-text-subtle text-sm text-left mb-4 max-w-md">
          ...
          <div className="text-left">
            ...
            <div className="space-y-2">
              <div className="flex items-start justify-start space-x-2 text-text-subtle text-sm">
                <MapPin className="h-4 w-4 text-accent-gold flex-shrink-0 mt-0.5" />
                <span className="text-left">Rua dos Carros, 123<br />1000-001 Lisboa</span>
              </div>
              <div className="flex items-center justify-start space-x-2 text-text-subtle text-sm">
        ...
        <div className="md:hidden">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-text-subtle text-sm mb-4 max-w-md mx-auto">
              O seu stand automóvel de confiança em Portugal. Especializados em carros usados 
              de qualidade com total transparência e preços justos.
            </p>
          ...
          {/* Duas Colunas: Links Rápidos e Contactos */}
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="text-left">
              ...
              <div className="space-y-3">
                <div className="flex items-start space-x-2 text-text-subtle text-sm">
                  <MapPin className="h-4 w-4 text-accent-gold flex-shrink-0 mt-0.5" />
                  <span className="text-left leading-tight">Rua dos Carros, 123<br />1000-001 Lisboa</span>
                </div>
